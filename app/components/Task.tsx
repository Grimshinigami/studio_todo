...
function Task({fn,fn2,giveParentData,filterType,searchVal}:
  ...
  return (
    <div className=" w-full flex flex-col ">
      {tasks.length!=0 && 
      <div className="w-full flex flex-row p-6 bg-[#FFF9F8] rounded-t-md border-b-2 border-[#941B0F] text-[#941B0F] sticky">
      ...
      <div className='w-full '>
        {tasks.map((task:TaskT)=>(
          ...
          <p className=" w-[12.5%] text-xs md:text-sm lg:text-base break-words">{task.title}</p>
          <p className=" w-[35%] text-xs md:text-sm lg:text-base break-words">{task.desc}</p>
